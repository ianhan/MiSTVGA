...
- `rtl/`: synthesizable RTL for the VGA core, PCI bridge, PLLs, and support blocks
- `fpga/a2gx/`: Quartus project files and top wrapper for the Arria II GX target
...
- `fpga/a2gx/a2gx_mistvga_top.sv`: Arria II GX board wrapper
