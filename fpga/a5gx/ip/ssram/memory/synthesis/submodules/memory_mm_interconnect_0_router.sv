...
module memory_mm_interconnect_0_router_default_decode
  #(
  ...
  (output [202 - 201 : 0] default_destination_id,
...
module memory_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    memory_mm_interconnect_0_router_default_decode the_default_decode(
