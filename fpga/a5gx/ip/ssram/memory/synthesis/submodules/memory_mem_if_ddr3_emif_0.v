...
`timescale 1 ps / 1 ps
module memory_mem_if_ddr3_emif_0 (
	...
	memory_mem_if_ddr3_emif_0_pll0 pll0 (
	...
	memory_mem_if_ddr3_emif_0_p0 p0 (
		.global_reset_n             (global_reset_n),                                                                                                                                                                            //        global_reset.reset_n
	...
	memory_mem_if_ddr3_emif_0_s0 s0 (
		.avl_clk                 (p0_avl_clk_clk),                               //          avl_clk.clk
		.avl_reset_n             (p0_avl_reset_reset),                           //        avl_reset.reset_n
		.scc_clk                 (p0_scc_clk_clk),                               //          scc_clk.clk
	...
	memory_mem_if_ddr3_emif_0_dmaster #(
		.USE_PLI     (0),
		.PLI_PORT    (50000),
		.FIFO_DEPTHS (2)
	) dmaster (
	...
	altera_mem_if_hard_memory_controller_top_arriav #(
		.MEM_IF_DQS_WIDTH                        (4),
		.MEM_IF_CS_WIDTH                         (1),
		.MEM_IF_CHIP_BITS                        (1),
		...
		.ENUM_CFG_SELF_RFSH_EXIT_CYCLES          ("DDR3_SELF_RFSH_EXIT_CYCLES"),
		...
		.ENUM_MEM_IF_TCL                         ("TCL_8"),
		.ENUM_MEM_IF_TCWL                        ("TCWL_6"),
		.ENUM_MEM_IF_TFAW                        ("TFAW_24"),
		.ENUM_MEM_IF_TMRD                        ("DDR3_TMRD"),
		.ENUM_MEM_IF_TRAS                        ("TRAS_20"),
		.ENUM_MEM_IF_TRC                         ("TRC_27"),
		...
		.avl_size_1              (7'b0000000),                         //        (terminated)
		...
		.avl_size_2              (7'b0000000),                         //        (terminated)
		...
		.avl_size_3              (7'b0000000),                         //        (terminated)
		...
		.avl_size_4              (7'b0000000),                         //        (terminated)
		...
		.avl_size_5              (7'b0000000),                         //        (terminated)
	...
	altera_mem_if_dll_arriav #(
		...
		.DLL_INPUT_FREQUENCY_PS_STR ("1876 ps")
	) dll0 (
	...
	memory_mem_if_ddr3_emif_0_mm_interconnect_1 mm_interconnect_1 (
